  ...
  <q-page class="q-pa-md bg-grey-2">
    <div class="row items-center q-mb-md">
      <div class="col-12 col-md-7">
        <div class="text-h5 text-weight-bold">Dashboard de Latinas Editores</div>
        <div class="text-caption text-grey-7">
          Resumen general de capacidad, estado y ocupacion.
        </div>
      </div>
      <div class="col-12 col-md-5">
        <div class="row items-center justify-end q-col-gutter-sm">
          <div class="col-12 col-sm-7">
            <q-input v-model="filter" dense outlined debounce="250" label="Buscar graderia..." clearable>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card flat bordered>
          <q-card-section class="row items-center">
            ...
            <div class="q-ml-md">
              <div class="text-caption text-grey-7">Graderias</div>
    ...
    <div class="row q-col-gutter-md q-mt-md">
      <div class="col-12 col-md-4">
        <q-card flat bordered>
          <q-card-section class="row items-center q-py-sm">
            <div class="text-subtitle1 text-weight-bold">Estado de graderias</div>
            <q-space />
          ...
          <q-card-section class="q-pa-sm">
            ...
            <div class="text-caption text-grey-7 q-mt-sm">
              Activas vs Inactivas segun el campo <b>activo</b>.
            </div>
          </q-card-section>
        </q-card>
      </div>
      ...
      <div class="col-12 col-md-8">
        <q-card flat bordered>
          <q-card-section class="row items-center q-py-sm">
            <div class="text-subtitle1 text-weight-bold">Capacidad por graderia</div>
            <q-space />
          ...
          <q-card-section class="q-pa-sm">
            ...
            />
            <div class="text-caption text-grey-7 q-mt-sm">
              Usa <b>capacidad_total</b> y si esta vacio se calcula filas por columnas.
            </div>
          </q-card-section>
        </q-card>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      topN: 8,
      graderias: [],
      estadosHint: 'Se calcula consultando /mis-graderias/{id}/venta uno por graderia. Si tienes muchas graderias, conviene luego crear un endpoint agregado.',
      columns: [
        { name: 'nombre', label: 'Graderia', field: 'nombre', align: 'left', sortable: true },
  ...
  methods: {
    async load () {
      ...
      try {
        ...
        this.$alert?.error?.(e.response?.data?.message || 'No se pudo cargar graderias')
      } finally {
        this.loading = false
      }
    },
